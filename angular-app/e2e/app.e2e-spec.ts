...
describe('Starting tests for angular-app', function() {
  ...
  it('network-name should be abcs@0.0.1',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('abcs@0.0.1.bna');
    });
  });
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('General component should be loadable',() => {
      ...
      .then((txt) => {
        expect(txt).toBe('General');
      });
    });

    it('General table should have 13 columns',() => {
      page.navigateTo('/General');
    ...
    it('Complete_Blood_Count component should be loadable',() => {
      page.navigateTo('/Complete_Blood_Count');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Complete_Blood_Count');
      });
    });

    it('Complete_Blood_Count table should have 13 columns',() => {
      page.navigateTo('/Complete_Blood_Count');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(13); // Addition of 1 for 'Action' column
      });
    ...
    it('Lipid_profile component should be loadable',() => {
      page.navigateTo('/Lipid_profile');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Lipid_profile');
      });
    });

    it('Lipid_profile table should have 12 columns',() => {
      page.navigateTo('/Lipid_profile');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(12); // Addition of 1 for 'Action' column
      });
    ...
    it('kidney_panel component should be loadable',() => {
      page.navigateTo('/kidney_panel');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('kidney_panel');
      });
    });

    it('kidney_panel table should have 12 columns',() => {
      page.navigateTo('/kidney_panel');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(12); // Addition of 1 for 'Action' column
      });
    ...
    it('HealthProvider component should be loadable',() => {
      page.navigateTo('/HealthProvider');
      browser.findElement(by.id('participantName'))
      .then((participantName) => {
        return participantName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('HealthProvider');
      });
    });

    it('HealthProvider table should have 6 columns',() => {
      page.navigateTo('/HealthProvider');
      element.all(by.css('.thead-cols th')).then(function(arr) {
